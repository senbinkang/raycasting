...
> 当前版本：**2026-06-14 — 武器+音效+门完成**（武器 HUD / 射击 / 敌人 HP / Web Audio 音效 / 门可开关 / 性能优化）
...
| `doc/_workflow/会话计划/2026-06-14-raycasting-未完成项-GL.md` | 历史档案：阶段 G~L（4.3~4.6 已完成，剩余 4.7~4.10） |
| `doc/_workflow/会话计划/2026-06-14-raycasting-性能优化-操作记录.md` | ~~本轮性能优化的操作记录~~（已删除，合并入操作记录目录） |
| `doc/操作记录/2026-06-14-raycasting武器AI音效门.md` | **本次新增**：武器 HUD + 射击 DDA + 敌人 HP/死亡 + Web Audio 音效 + 门系统 |
